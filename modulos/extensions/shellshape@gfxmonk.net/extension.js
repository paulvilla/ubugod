...
(function (Logging) {
    ...
    function getLogger(name) { return log4js.getLogger(name); }
...
(function (Tiling) {
    ...
    var Tile = (function () {
        ...
        Tile.rect_eq = function (a, b) {
            return (Tile.point_eq(a.pos, b.pos) &&
    ...
    Tile.log = Logging.getLogger('shellshape.tiling.Tile');
    Tiling.Tile = Tile;
    var TileCollection = (function () {
        ...
        TileCollection.prototype.sorted_view = function (filter) {
            return this.filter(function (obj) { return filter(obj.item); }, this.sorted_with_indexes());
        };
    ...
    var MultiSplit = (function (_super) {
        ...
        function MultiSplit(axis, primary_windows) {
            ...
            _this.log = Logging.getLogger("shellshape.tiling.MultiSplit");
            _this.primary_windows = primary_windows;
            return _this;
        }
    ...
    var BaseLayout = (function () {
        ...
        BaseLayout.prototype.each_tiled = function (func) {
        ...
        BaseLayout.prototype.override_external_change = function (win, delayed) { };
    ...
    var FloatingLayout = (function (_super) {
        ...
        function FloatingLayout(state) {
            return _super.call(this, 'FloatingLayout', state) || this;
        }
    ...
    var FullScreenLayout = (function (_super) {
        ...
        function FullScreenLayout(state) {
            return _super.call(this, 'FullScreenLayout', state) || this;
        }
    ...
    var BaseTiledLayout = (function (_super) {
        ...
        function BaseTiledLayout(name, axis, state) {
            ...
            _this.main_axis = axis;
            _this.bounds = state.bounds;
            _this.main_split = state.splits[_this.main_axis].main;
            _this.splits = state.splits[_this.main_axis].minor;
            return _this;
        }
        ...
        BaseTiledLayout.prototype.override_external_change = function (win, delayed) {
    ...
    var VerticalTiledLayout = (function (_super) {
        ...
        function VerticalTiledLayout(state) {
            return _super.call(this, 'VerticalTiledLayout', 'x', state) || this;
        }
    ...
    var HorizontalTiledLayout = (function (_super) {
        ...
        function HorizontalTiledLayout(state) {
            return _super.call(this, 'HorizontalTiledLayout', 'y', state) || this;
        }
    ...
    var TiledWindow = (function () {
        ...
        TiledWindow.prototype._enforce_layout = function (delayed) {
            ...
            if (Logging.PARANOID) {
                ...
                var max_diff = Math.max(position_diff.x, position_diff.y, size_diff.x, size_diff.y);
...
(function (Indicator) {
    ...
    var ShellshapeIndicator = (function () {
        ...
        ShellshapeIndicator.prototype._init = function (ext) {
            ...
            this.ext = ext;
            PanelMenu.Button.prototype._init.call(this, 0.0, // menuAlignment
            ...
            Util.connect_and_track(this, global.screen, 'workspace-switched', Lang.bind(this, this._workspaceChanged), true // use connect-after
            );
        ...
        ShellshapeIndicator.prototype._current_workspace = function () { return this.ext.current_workspace(); };
        return ShellshapeIndicator;
    }());
...
(function (MutterWindow) {
    ...
    var Window = (function () {
        ...
        Window.prototype.activate_before_redraw = function (reason) {
            ...
            Meta.later_add(Meta.LaterType.IDLE, //when
            function () {
...
(function (Workspace_1) {
    ...
    var Workspace = (function () {
        function Workspace(meta_workspace, layout_state, ext) {
            ...
            this.on_window_unexpected_change = _duck_overview(this._on_window_unexpected_change);
        ...
        Workspace.prototype._relayout = function () { this.layout.layout(); };
        ...
        Workspace.prototype._grab_op_signal_handler = function (change, relevant_grabs, responder) {
        ...
        Workspace.prototype._on_window_moved = function (win) { this.layout.on_window_moved(win); };
        Workspace.prototype._on_window_resized = function (win) { this.layout.on_window_resized(win); };
        Workspace.prototype._on_window_unexpected_change = function (win) {
            var self = this;
            Mainloop.idle_add(function () {
...
(function (ShellshapeSettings) {
    ...
    function get_local_gsettings(schema_path) {
        ...
        if (!schemaObj) {
            throw new Error('Schema ' + schema_path +
